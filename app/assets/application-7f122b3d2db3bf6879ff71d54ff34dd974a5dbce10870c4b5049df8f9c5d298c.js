...
(function() {
	angular.module('welcomeApp', ['customFilters','ngRoute','ngResource']);
})();
/**
 * @author austin.hammer
 */
...
//			UserService.save({userId:controller.currentUserId}).$promise
//				.then(function(data) {
//					var bma = false;
//				});
		};
...
(function() {
	...
	UserListController.$inject = ['UserService','$location'];
...
(function() {
	...
	function UserService($resource) {
		return $resource('/D2/api/users/:userId', {userId: '@userId'});
	}
})();
/*
 AngularJS v1.4.8
